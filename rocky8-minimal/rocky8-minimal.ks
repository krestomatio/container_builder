# This is a minimal Rocky Linux kickstart for containers.
# It will not produce a bootable system
# To use this kickstart, run the following command
# livemedia-creator --make-tar --ks="rocky8-minimal.ks" --image-name="rocky8-minimal.tar.xz" --no-virt
#
# Based on:
# https://git.rockylinux.org/sig/containers/docker-build/-/blob/main/rocky-8.ks
